...
class App {
    ...
    async renderCategorySelection() {
        ...
        const categoryDescriptions = {
            'лидеры_стратегии': 'Обеспечиваете стратегическое видение, принимаете решения по крупным цифровым инициативам, формируете портфель трансформационных проектов, определяете целевые показатели и управляете эффектами на уровне компании.',
            'руководители': 'Переводите стратегические направления в операционные планы, обеспечиваете реализацию цифровых инициатив, управляете командами и распределением ресурсов.',
            'эксперты_по_цифровым_направлениям': 'Осуществляете методологическую и архитектурную экспертизу, проектируете цифровые решения, управляете данными, обеспечиваете согласованность систем и процессов.',
            'пользователи': 'Используете корпоративные цифровые системы в операционной деятельности, обеспечиваете выполнение процессов, корректность данных и взаимодействие между функциями.',
            'рабочие_на_промысле': 'Обеспечиваете работу производственных процессов, используете цифровые инструменты операционной деятельности, фиксируете данные, взаимодействуете с сенсорикой, АСУ ТП, мобильными сервисами.'
        };
